 ...
 * @param usuario dados do usuário autenticado, para o frontend não precisar chamar /api/auth/me
 *     logo após o login
 */
public record LoginResponseDTO(
    String accessToken, String tokenType, long expiresIn, UsuarioResponseDTO usuario) {
  public static LoginResponseDTO bearer(
      String accessToken, long expiresIn, UsuarioResponseDTO usuario) {
