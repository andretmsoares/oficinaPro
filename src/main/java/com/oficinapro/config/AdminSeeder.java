 ...
 *
 * <p>Existe porque não há como criar usuário pela API sem estar autenticado, o que tornaria a
 * instalação inicial impossível. Grava direto pelo repositório, sem passar pelo UsuarioService,
 * justamente porque não existe usuário logado aqui.
 *
 * <p>Só age se ADMIN_USERNAME e ADMIN_PASSWORD estiverem definidos e se ainda não existir nenhum
 * ADMIN, então reiniciar a aplicação nunca sobrescreve a senha de um admin já existente.
 */
@Component
public class AdminSeeder implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    log.info(
        "ADMIN do SaaS '{}' criado. Troque a senha e remova ADMIN_PASSWORD do ambiente.", username);
  }
}
