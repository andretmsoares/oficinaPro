...
class RegistroPagamentoControllerTest {
  ...
  @MockitoBean private RegistroPagamentoService registroPagamentoService;
  ...
  void buscarPorId_encontrado_retorna200() throws Exception {
    ...
    mockMvc
        .perform(get("/api/registros-pagamento/100"))
  ...
  void buscarPorId_naoEncontrado_retorna404() throws Exception {
    ...
    mockMvc.perform(get("/api/registros-pagamento/999")).andExpect(status().isNotFound());
  }
  ...
  void listarPorPagamento_retornaLista() throws Exception {
    ...
    mockMvc
        .perform(get("/api/registros-pagamento/pagamento/10"))
        .andExpect(status().isOk())
  ...
  void deletar_gerente_retorna204() throws Exception {
    ...
    mockMvc
        .perform(delete("/api/registros-pagamento/100").with(csrf()))
