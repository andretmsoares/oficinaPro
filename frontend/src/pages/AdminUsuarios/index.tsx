...
import "../Usuarios/usuarios.style.css";
...
export function AdminUsuarios() {
  ...
  const oficinaOptions = MOCK_OFICINAS.map((oficina) => ({
    label: oficina.nome,
  ...
  function handleAddUsuario(data: UsuarioFormData) {
    ...
    // TODO: substituir por chamada real ao backend (POST /admin/usuarios).
    const { password: _password, ...rest } = data;
    void _password;

    const oficinaId = rest.role === "ADMIN" ? null : (rest.oficinaId ?? null);
  ...
  return (
    <div className="page">
      <HeaderPageWithButton
        title="Usuários"
        subtitle="Gerencie os usuários de todas as oficinas"
      ...
      {isModalOpen && (
        <EntityForm<UsuarioFormData>
          ...
          fields={createUsuarioFields(oficinaOptions)}
